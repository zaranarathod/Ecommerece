...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_email_sender/flutter_email_sender.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_facebook_auth/flutter_facebook_auth.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_open_whatsapp/flutter_open_whatsapp.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_social_content_share/flutter_social_content_share.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/rate_my_app/rate_my_app.framework"
