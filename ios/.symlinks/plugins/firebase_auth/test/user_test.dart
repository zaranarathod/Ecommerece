  ...
  group("$User", () {
    ...
    test('toString()', () async {
      ...
      expect(
          ...
          equals(
              'User(displayName: displayName, email: null, emailVerified: false, isAnonymous: true, metadata: UserMetadata(creationTime: ${DateTime
                  .fromMillisecondsSinceEpoch(
                  kMockCreationTimestamp)}, lastSignInTime: ${DateTime
                  .fromMillisecondsSinceEpoch(kMockLastSignInTimestamp)
                  .toString()}), phoneNumber: null, photoURL: null, providerData, [UserInfo(displayName: Flutter Test User, email: test@example.com, phoneNumber: null, photoURL: http://www.example.com/, providerId: firebase, uid: 12345)], refreshToken: null, tenantId: null, uid: null)'));
    });
  });
}
...
class MockUserCredentialPlatform extends Mock
  ...
  MockUserCredentialPlatform(FirebaseAuthPlatform auth,
...
class TestUserCredentialPlatform extends UserCredentialPlatform {
  TestUserCredentialPlatform(FirebaseAuthPlatform auth,
      AdditionalUserInfo additionalUserInfo,
      AuthCredential credential,
      UserPlatform userPlatform)
      : super(
