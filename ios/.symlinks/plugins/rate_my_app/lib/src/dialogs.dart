...
class RateMyAppDialog extends StatelessWidget {
  ...
  const RateMyAppDialog(this.rateMyApp, {
    @required this.title,
...
class RateMyAppStarDialog extends StatefulWidget {
  ...
  const RateMyAppStarDialog(this.rateMyApp, {
    @required this.title,
    @required this.message,
    @required this.contentBuilder,
    this.actionsBuilder,
...
abstract class _RateMyAppDialogButton extends StatelessWidget {
  ...
  const _RateMyAppDialogButton(this.rateMyApp, {
    @required this.text,
...
class RateMyAppRateButton extends _RateMyAppDialogButton {
  ...
  const RateMyAppRateButton(RateMyApp rateMyApp, {
...
class RateMyAppLaterButton extends _RateMyAppDialogButton {
  ...
  const RateMyAppLaterButton(RateMyApp rateMyApp, {
    @required String text,
    Validator validator,
    VoidCallback callback,
  }) : super(
...
class RateMyAppNoButton extends _RateMyAppDialogButton {
  ...
  const RateMyAppNoButton(RateMyApp rateMyApp, {
    @required String text,
    Validator validator,
    VoidCallback callback,
  }) : super(
